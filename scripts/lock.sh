...
WALLPAPER_DIR="/mnt/tsa/Wallpapers/" # change this to your wallpaper directory
...
225161
225161
# Rulează swaylock în background
# -f = fullscreen
# --layout us = folosește layout US (schimbă dacă vrei alt layout)
